    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Tambah Kegiatan Sosial</h2>
            </div>
        </div>
        ...
        <form action="{{ route('kegiatan.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded">
                    ...
                    <input type="text" id="judul" name="judul" required
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm p-2.5 focus:ring-primary-500 focus:border-primary-500">
                </div>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="5"
                    class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm p-2.5 focus:ring-primary-500 focus:border-primary-500"></textarea>
            </div>
