...
<aside id="sidebar"
    ...
    <div
            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            aria-controls="Menu Volunteer" data-collapse-toggle="Menu Volunteer">
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Manage Distribusi</span>
                        ...
                        <ul id="Menu Volunteer" class="hidden py-2 space-y-2">
                            <li>
                ...
                <div class="pt-2 space-y-2">
                    ...
                    @if (Session::get('user')['role'] === 'admin')
                        {{-- <a href="{{ route('home') }}" target="_blank"
                            class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <svg class="flex-shrink-0 w-6 h-6 transition duration-75 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Log Riwayat Token</span>
                        </a> --}}
                    @endif
                </div>
            </div>
        ...
        <div
            ...
            <small class="text-gray-500 dark:text-white">© Sistem Donasi 2025</small>
        </div>
    </div>
</aside>
