                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-playground" class="space-y-2 py-2">
                            {{-- class="space-y-2 py-2 @if ($params['group'] !== 'playground') hidden @endif"> --}}
                            <li>
                                <a href="#"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 @if ($page_slug === 'stacked') bg-gray-100 dark:bg-gray-700 @endif">
                                    Stacked
                                </a>
                            </li>
                            <li>
                                <a href="#"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 @if ($page_slug === 'sidebar') bg-gray-100 dark:bg-gray-700 @endif">
                                    Sidebar
                                </a>
                            </li>
